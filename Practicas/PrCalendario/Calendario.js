...
lasemana = ["Domingo", "Lunes","Martes","Miércoles","Jueves","Viernes","Sabado"]
...
window.onload = function(){
    ...
    //Elementos del DOM
    tit=this.document.getElementById("titulos");
    ant=this.document.getElementById("anterior");
    pos=this.document.getElementById("posterior");

    f0=document.getElementById("fila0");

    pie=this.document.getElementById("fechaactual");
    pie.innerHTML+= lasemana[diasemhoy]+ ", "+ diahoy + " de " + meses[meshoy] + " de " + annohoy;

    this.document.buscar.buscaanno.value=annohoy;

    //elemenetos iniciales 
    mescal=meshoy;
    annocal=annohoy;
    ...
    for (i=1;i<7;i++) { //localizar fila
        ...
        for (j=0;j<7;j++) {
            ...
            if (mimes==meshoy && midia==diahoy && mianno==annohoy ) { 
               celda.style.backgroundColor="#69f0ae";
